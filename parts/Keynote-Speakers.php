...
<div class="col ">
	...
	<div class="member-wrap">
					 ...
					 <div class="member-bio">
							<h4 class="team-member-name">Prof. Kamal Youcef-Toumi</h4>
...
Forces of Change in the Digital Age
	 ...
	 The revolution of big data simulation and big data analytics has empowered the high resolution of
         ...
         decision making accurately.
	                         ...
	                         <div class="member-photo">
	                            <div class="shadow_img_frame shadow_square">
	                               <div class="img-preload"><img src="assests/images/speackers/omer-rana2.jpg" alt="" class="attachment-fadeIn" style="display: inline;"></div>
	                            </div>
	                         </div><!-- END member-photo -->
...
<!-- =========================================================== -->
												<div class="member-wrap">
																	<div class="member-photo">
																		 <div class="shadow_img_frame shadow_square">
																				<div class="img-preload"><img src="assests/images/speackers/Stephanie August.jpg" alt="" class="attachment-fadeIn" style="display: inline;"></div>
																		 </div>
																	</div><!-- END member-photo -->
															 ...
															 <div class="member-wrap">
															 					<div class="member-photo">
															 						 <div class="shadow_img_frame shadow_square">
															 								<div class="img-preload"><img src="assests/images/speackers/AP Dr Norma Alias.jpg" alt="" class="attachment-fadeIn" style="display: inline;"></div>
															 						 </div>
															 					</div><!-- END member-photo -->
