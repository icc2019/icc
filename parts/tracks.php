    ...
    <div class="one_half tt-column">
                       <div class="tabs-area ui-tabs ui-widget ui-widget-content ui-corner-all">
                          <ul class="tabset ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
                             <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="-1" aria-controls="tab-3" aria-labelledby="ui-id-4" aria-selected="false"><a href="#tab-3" class="tab ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-4"><b>   Track1: Data Science </b></a></li>
