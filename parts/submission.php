...
<br> <br>
Papers are required in PDF format for review purposes, but authors are required to upload editable word-processor files (  <a href="assests/Latex.zip" target="_blank" download>  LaTeX  </a> or  <a href="assests/Word.zip" target="_blank" download> MS Word </a> ) at the end of the review process. Please find the correct template options below.
