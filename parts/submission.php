...
<br> <br>
Papers are required in PDF format for review purposes, but authors are required to upload editable word-processor files ( <!-- <a href="https://www.dropbox.com/s/0bf2vryzd7zsfpv/Latex.zip?dl=0" target="_blank"> --> LaTeX <!-- </a> --> or  <!-- <a href="https://www.dropbox.com/s/w7iylzuxct97twt/Word.zip?dl=0" target="_blank"> --> MS Word <!-- </a> --> ) at the end of the review process. Please find the correct template options below.
