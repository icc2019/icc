...
<br> <br>
Papers are required in PDF format for review purposes, but authors are required to upload editable word-processor files ( <b> <a href="assests/Latex.zip" target="_blank" download>  LaTeX  </a> </b> or <b> <a href="assests/Word.zip" target="_blank" download> MS Word </a> </b> ) at the end of the review process. Please find the correct template options below.
...
<br> <br>
 ...
 <ul>
    ...
    <p align="justify"> CCIS is abstracted/indexed in DBLP, Google Scholar, EI-Compendex, Mathematical Reviews, SCImago, Scopus. CCIS volumes are also submitted for the inclusion in ISI Proceedings.  </p>
    </p>
  <br>
...
<p align="justify">  Each contribution must be accompanied by a Springer copyright form, a so-called 'Consent to Publish' form. <b> <a href="assests/Contract_Book_Contributor_Consent_to_Publish_CCIS_SIP.pdf" target="_blank" download>Download the copyright form </a> </b>. </p>

<p align="justify"> Modified forms are not acceptable. Authors will be asked to transfer the copyright of the paper to the Springer. This will ensure the widest possible protection and dissemination of information under copyright laws. One author may sign on behalf of all of the authors of a particular paper. In this case, the author signs for and accepts responsibility for releasing the material on behalf of all co-authors. </p> 
</p>
