...
<div class="testimonials flexslider" style="height: 128px;">
            ...
            <img src="assests/images/Abour_Riyad/1.png" alt="" />
         </div>
							<blockquote>
                     <h2 class="slider-post-title">Kingdom Centre Tower (Al-Mamlaka Tower)​​</h2>
          <p>
...
http://kingdomcentre.com.sa/?page_id=1452">More Information</a></strong>
						 ...
						 <li style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;" class="">
                   <div class="slider-content-sub">
            <img src="assests/images/Abour_Riyad/2.png" alt="" />
         </div>
							<blockquote>
                     <h2 class="slider-post-title">Al Masmak Museum</h2>
            <p>
  ...
  http://www.sauditourism.sa/en/aboutKSA/CultureAndHistory/Museums/Pages/AlMasmakHistorical-.aspx">More Information</a></strong>
         ...
         <div class="slider-content-sub">
            <img src="assests/images/Abour_Riyad/3.png" alt="" />
         </div>
							<blockquote>
                     <h2 class="slider-post-title">Al Bujairi Heritage Park</h2>
            <p>
   ...
   <strong>For information regarding visiting hours and location visit: <br />
  Visiting hours and location:<br />
Hours: open 24 hours a day<br />
Location: 3134 Wadi Hanifah, Al Bujairi, Riyadh 13711
</strong>
            </p>
							</blockquote>
						 </li>
                   ...
                   <div class="slider-content-sub">
                      <img src="assests/images/Abour_Riyad/4.png" alt="" />
                   </div>
                               <blockquote>
                               <h2 class="slider-post-title">Al Bujairi Heritage Park</h2>
                               <h2 class="slider-post-title">King Abdullah Park</h2>
          <p>
          ...
          <p>
            <strong>Visiting hours and location:<br />
Hours: 1pm-12am everyday of the week<br />
Location: : Al Ameen Abdullah Al Ali Al Naeem Street, Riyadh 12836</strong>
          </p>
                               </blockquote>
                             </li>
                   ...
                   <div class="slider-content-sub">
                      <img src="assests/images/Abour_Riyad/5.png" alt="" />
                   </div>
                               <blockquote>
                               <h2 class="slider-post-title">National Museum of Saudi Arabia
</h2>
            <p>
   ...
   <strong><a href="http://www.nationalmuseum.org.sa/introduction.aspx">More Information</a></strong>
                   ...
                   <div class="slider-content-sub">
                      <img src="assests/images/Abour_Riyad/6.png" alt="" />
                   </div>
                               <blockquote>
                               <h2 class="slider-post-title">National Museum of Saudi Arabia
</h2>
...
Location: 3134 Wadi Hanifah, Al Bujairi, Riyadh 13711
				   ...
				   <ul class="flex-direction-nav"><li><a class="flex-prev" href="#"><span>&nbsp;</span></a></li><li><a class="flex-next" href="#"><span>&nbsp;</span></a></li></ul></div>