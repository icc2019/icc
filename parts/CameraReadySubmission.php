...
<ul style="list-style-type:circle;">
  <li>Appendices are material that can be read, and include lemmas, formulas, proofs, and tables that &nbsp; &nbsp; &nbsp; are not critical to the reading and understanding of the paper. In your final camera-ready paper, appendices come after the references in the main paper (see the Springer templates). Appendices do not count towards the page limit.</li>
  <li>Non-readable supplemental material should follow the Springer templates.</li>
