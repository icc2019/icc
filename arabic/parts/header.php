        ...
        <!-- <div class="toolbar-right">
         ...
         <!--<div class="toolbar-left">
            <ul>
               ...
               <li><a href="arabic/pages/Departments" class="" title=" ">هيئة التدريس</a></li>
               <li><a href="arabic/pages/Graduates" class="a" title=" ">طالبة</a></li>
            </ul>
         </div>-->
         <!-- END toolbar-right -->
      </div>
         ...
         <div class="header-area">
            ...
            <nav role="navigation">
               <ul id="menu-main-nav">
                  ...
                  <li>
                     <a href="template-gallery-1-column.html" class="nav-link"><span><strong>Workshops </strong></span></a>
                     <ul class="sub-menu">

                        <li>
                           <a href="template-faq-1.html"><span>  Workshops Tracks </span></a>

                        </li>
                        <li>
                           <a href="template-faq-1.html"><span>  Workshop Proposal </span></a>
                  ...
                  <li>
                     <a href="template-sliders-karma-jquery-1.html" class="nav-link"><span><strong>Attending</strong></span></a>
                     <ul class="sub-menu">
                        <li><a href="template-sliders-karma-jquery-1.html"><span>  Registration</span></a></li>
                        <li><a href="template-sliders-karma-jquery-1.html"><span>Needed Forms </span></a></li>
                        <li><a href="template-sliders-karma-jquery-1.html"><span> Venue</span></a></li>
                        <li><a href="template-sliders-karma-jquery-1.html"><span>   About Riyadh</span></a></li>
                  ...
                  <li>
                     <a href="template-gallery-1-column.html" class="nav-link"><span><strong> Program</strong></span></a>
                     <ul class="sub-menu">


                       <li> <a href="template-classic-3-column-home.html"><span>   Keynote Speakers  </span></a>  </li>
                          <li> <a href="template-classic-3-column-home.html"><span>  Program   </span></a>  </li>
