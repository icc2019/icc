   ...
   <ul class="slides">
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/1.png" alt="" />
         </div>
...
http://kingdomcentre.com.sa/?page_id=1452">More Information</a></strong>
      ...
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/2.png" alt="" />
         </div>
         <div class="slider-content-main">
  ...
  http://www.sauditourism.sa/en/aboutKSA/CultureAndHistory/Museums/Pages/AlMasmakHistorical-.aspx">More Information</a></strong>
      ...
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/3.png" alt="" />
         </div>
         <div class="slider-content-main">
...
Location: 3134 Wadi Hanifah, Al Bujairi, Riyadh 13711
      ...
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/4.png" alt="" />
         </div>
         <div class="slider-content-main">
...
Location: : Al Ameen Abdullah Al Ali Al Naeem Street, Riyadh 12836</strong>
      ...
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/5.png" alt="" />
         </div>
         <div class="slider-content-main">
   ...
   <strong><a href="http://www.nationalmuseum.org.sa/introduction.aspx">More Information</a></strong>
      ...
      <li class="jqslider karma-slider-normal-image">
         ...
         <div class="slider-content-sub">
            <img src="assests/images/attending/6.png" alt="" />
         </div>
         <div class="slider-content-main">
            <h2 class="slider-post-title">
Tuwaiq Mountains (The Edge of The World)</h2>
          <p>
